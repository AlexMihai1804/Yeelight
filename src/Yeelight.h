...
/**
 * @brief Enumeration of scene classes for controlling the scene of the Yeelight device.
 */
enum scene_class {
    SCENE_COLOR,                /**< Color scene class */
    SCENE_HSV,                  /**< HSV scene class */
    SCENE_CT,                   /**< Color temperature scene class */
    SCENE_CF,                   /**< Color flow scene class */
    SCENE_AUTO_DELAY_OFF        /**< Auto delay off scene class */
};
